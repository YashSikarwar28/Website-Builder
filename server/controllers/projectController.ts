//This code is to tell the ai model that the user wants to make changes in the code or the website generated

import { Request, Response } from "express";
import prisma from "../lib/prisma.js";
import openai from "../configs/openai.js";

//controller function for making revision
...
`,
    ...
    await prisma.conversation.create({
      data: {
        role: "assistant",
        content: "Changes have been made! You can now preview it.",
        projectId,
      },
    });
...
// Controller function to rollback to specific function
export const rollbackToVersion = async (req: Request, res: Response) => {
  try {
    ...
    await prisma.conversation.create({
      data: {
        role: "assistant",
        content: "Rolled back to your selected version. You can now preview it",
        projectId,
      },
    });
