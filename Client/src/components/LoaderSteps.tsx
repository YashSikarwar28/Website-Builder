//when we give prompts the AI will show messages like generating code, making changes and saving your code int the message area.
...
const steps=[
    ...
    {icon:TriangleIcon, label:"Assembling your website"},
...
const LoaderSteps = () => {
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
      <div className='absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to bg-fuchsia-500/10 blur-3xl animate-pulse'></div>
