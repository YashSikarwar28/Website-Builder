  ...
  return (
    <>
      <nav className="z-50 flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white border-slate-800">
        <Link to="/">
          <h1 className="md:text-3xl text-[32px] tracking-wide font-bold">
            Voltify
          </h1>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
          ...
          <Link className="hover:text-purple-300" to="/projects">
            My Projects
          </Link>
          <Link className="hover:text-purple-300" to="/community">
            Community
          </Link>
          <Link className="hover:text-purple-300" to="/pricing">
            Pricing
          </Link>
        </div>
