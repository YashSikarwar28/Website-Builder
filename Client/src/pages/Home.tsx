...
const Home = () => {
  ...
  return (
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      ...
      <h1 className="text-center text-[30px] pt-10 leading-[48px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-3xl mx-auto">
        <span className="block md:inline">Stop building websites,</span>{" "}
        <span className="block md:inline">Start shipping them.</span>
      </h1>

      <p className="text-center text-base max-w-md mt-2">
        Turn prompts into beautiful, production ready websites powered by AI.
      </p>

      <form
        onSubmit={onSubmitHandler}
        className="bg-transparent max-w-2xl w-full rounded-xl p-4 mt-10 border border-indigo-600/70 focus-within:ring-2 ring-indigo-500 transition-all"
      >
        <textarea
